...
class update_frame_id:
    def __init__(self):
        ...
        self.sub_raw = rospy.Subscriber("/camera/color/image_raw", Image, self.callback_raw)
        self.sub_info = rospy.Subscriber("/camera/depth/camera_info", CameraInfo, self.callback_info)
