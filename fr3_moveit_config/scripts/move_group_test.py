...
class MoveGroupTest(object):
    ...
    def __init__(self):
        ...
        # Initialize the MoveGroupCommander object. This object is the interface of the fr3 manipulator planning group, which is used to plan and execute the manipulator motion.
        group_name = "fr3_arm"
